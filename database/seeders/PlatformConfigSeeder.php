...
class PlatformConfigSeeder extends Seeder
{
    public function run(): void
    {
        $configs = [
            ...
            ['key' => 'driver_assignment_radius_miles', 'value' => '5', 'description' => 'Max distance (miles) from the restaurant within which an online driver is offered a newly-accepted order'],
            ['key' => 'driver_average_speed_mph', 'value' => '18', 'description' => 'Average delivery speed used to estimate restaurant→customer travel time'],
            ['key' => 'default_prep_time_minutes', 'value' => '20', 'description' => 'Fallback kitchen prep time (minutes) when a restaurant has not set its own'],
